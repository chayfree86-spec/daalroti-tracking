  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 max-w-lg w-full overflow-hidden relative z-10 font-nunito"
      >
        {/* Header */}
        ...
        <div className="p-6">
          {activeSubTab === 'account' && (
            <form onSubmit={handleUpdateMobile} className="space-y-4">
              <div>
                ...
                <div className="p-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-slate-700 font-bold text-sm flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-2xl text-slate-900 font-bold text-sm focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-all"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3.5 bg-slate-900 hover:bg-slate-800 text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer mt-2"
              >
          ...
          {activeSubTab === 'password' && (
            <form onSubmit={handleUpdatePassword} className="space-y-3.5">
              <div>
                <label className="block text-[11px] font-black uppercase tracking-wider text-slate-600 mb-1 ml-1">
                  Current Password
                </label>
                <div className="relative flex items-center">
                  <div className="absolute left-4 text-slate-400 pointer-events-none">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-11 py-3 bg-white border border-slate-200 rounded-2xl text-slate-900 font-bold text-sm focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-all"
                  />
                  <button
                    type="button"
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-red-50 hover:bg-red-100 text-red-600 border border-red-200/60 font-black text-xs uppercase tracking-wider flex items-center gap-2 transition-all cursor-pointer"
            >
              <LogOut size={15} />
              <span>Logout</span>
            </button>
        ...
        {showLogoutConfirm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl p-6 shadow-2xl border border-slate-100 max-w-sm w-full relative z-10 text-center font-nunito"
            >
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={() => setShowLogoutConfirm(false)}
                  className="flex-1 py-3 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-black text-xs uppercase tracking-wider transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
